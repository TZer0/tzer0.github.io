...
* Once your server hits more 1000 users, you're going to start needing the following:
  ...
  * Instructions for users on when to contact moderators in DMs. You can't avoid DMs regarding certain things such as reports of harassment, but there needs to be some effort in avoiding DMs being sent to moderators/admins as sooner or later you'll be getting too many (or maybe one particular mod is getting too many and no one knows about it).
